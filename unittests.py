...
class TestRecent30DayBornorDeath(unittest.TestCase):
    def test_verifyBirthAtRecent30Days(self):
        self.assertTrue(project03.verifyBirthAtRecent30Days(examples.examplePersonRecentBirth))

    def test_verifyDeathAtRecent30Days(self):
        self.assertTrue(project03.verifyDeathAtRecent30Days(examples.examplePersonRecentDeath))

    def test_PersonNotRecentDeath(self):
        self.assertFalse(project03.verifyDeathAtRecent30Days(examples.examplePersonNotRecentDeath))
